...
//const category_trip = const [Trip(id: id, categories: categories, activities: activities, duration: duration, imageUrl: imageUrl, isForFamilies: isForFamilies, isInSummer: isInSummer, isInWinter: isInWinter, program: program, season: season, title: title)];
